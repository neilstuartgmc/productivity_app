...
df_filtered_sidebar = df[
    df["Year"].series.str.contains(year) &
    df["Month"].series.str.contains(month) &
    df["Cell"].series.str.contains(cell) &
    df["Resource"].series.str.contains(resource) &
    df["Outcome"].series.str.contains(outcome)
]
